...
;(function (global, factory) {
    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            // Texts
            text:{
                noRecordsFound:'هیچ اطلاعاتی یافت نشد',
                showingPage:'نمایش صفحه {0} از {1} ورودی',
                show:'نشان دادن',
                entries:'ورودی ها',
                insertANewColumnBefore:'قبل از آن یک ستون جدید وارد کنید',
                insertANewColumnAfter:'ستون جدید را بعد از آن وارد کنید',
                deleteSelectedColumns:'ستون های انتخاب شده را حذف کنید',
                renameThisColumn:'این ستون را تغییر نام دهید',
                orderAscending:'ترتیب صعودی',
                orderDescending:'ترتیب نزولی',
                insertANewRowBefore:'قبل از آن یک خط جدید وارد کنید',
                insertANewRowAfter:'بعد از وارد کردن یک خط جدید',
                deleteSelectedRows:'ردیف های انتخاب شده را حذف کنید',
                editComments:'نظرات را ویرایش کنید',
                addComments:'نظرات اضافه کنید',
                comments:'نظرات',
                clearComments:'نظرات را پاک کنید',
                copy:'کپی ...',
                paste:'چسباندن ...',
                saveAs:'ذخیره ...',
                about:'درباره',
                areYouSureToDeleteTheSelectedRows:'آیا مطمئن هستید که خطوط انتخاب شده را حذف می کنید؟',
                areYouSureToDeleteTheSelectedColumns:'مطمئن هستید ستون های انتخاب شده را حذف کنید؟',
                thisActionWillDestroyAnyExistingMergedCellsAreYouSure:'این عمل باعث نابودی همه سلولهای ادغام شده موجود می شود. مطمئنی؟',
                thisActionWillClearYourSearchResultsAreYouSure:'این نتایج جستجوی شما را پاک می کند. مطمئنی؟',
                thereIsAConflictWithAnotherMergedCell:'درگیری با سلول ادغام شده دیگر وجود دارد',
                invalidMergeProperties:'خواص ادغام نشده نامعتبر است',
                cellAlreadyMerged:'سلول قبلاً ادغام شده است',
                noCellsSelected:'هیچ سلول انتخاب نشده است',
                search:'جستجو',
            },
            // About message
            about:"Baradaran System ERP.",
        };
        ...
        obj.createTable = function() {
            ...
            span.innerHTML = 'نرم افزار یکپارچه مالی برادران سیستم';
                ...
                if (jexcel.current.resizing) {
                    if (jexcel.current.resizing.column) {
                        ...
                        if (jexcel.current.resizing.width + width > 0) {
                            ...
                            jexcel.current.colgroup[jexcel.current.resizing.column - 1].setAttribute('width', tempWidth);
